...
def main_send_email(request, receiver_email, the_subject, the_content):
    try:
        msg = EmailMessage(
            the_subject,
            the_content,
...
def send_verification_email(request, user):
    ...
    content = render_to_string("emails/verify_email_body.html", {
        'user': user,
        'current_site': current_site,
        'activation_link': activation_link
    })

    main_send_email(request, email, subject, content)
...
def send_password_reset_email(request, user):
    ...
    content = render_to_string("emails/password_reset_req_email_body.html", {
        'user': user,
        'current_site': current_site,
