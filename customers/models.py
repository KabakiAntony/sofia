...
class Address(models.Model):
    ...
    area = models.ForeignKey(Area, on_delete=models.SET_NULL, null=True, verbose_name="Area")
    street_lane_other = models.CharField(max_length=200, blank=True, verbose_name="Street / Lane / Other")
    apartment_suite_building = models.CharField(max_length=200, blank=True, verbose_name="Apartment / Suite / Building")
